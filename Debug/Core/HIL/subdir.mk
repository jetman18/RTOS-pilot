...
C_SRCS += \
../Core/HIL/dynamic_mode.c 

OBJS += \
./Core/HIL/dynamic_mode.o 

C_DEPS += \
./Core/HIL/dynamic_mode.d 


# Each subdirectory must supply rules for building sources it contributes
Core/HIL/%.o: ../Core/HIL/%.c Core/HIL/subdir.mk
...
clean: clean-Core-2f-HIL

clean-Core-2f-HIL:
	-$(RM) ./Core/HIL/dynamic_mode.d ./Core/HIL/dynamic_mode.o

.PHONY: clean-Core-2f-HIL
